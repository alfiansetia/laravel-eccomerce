                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item"><a href="{{ route('user.password') }}" class="nav-link active">Password</a>
                            </li>
                ...
                <form id="setting-form" method="POST" action="{{ route('user.password.update') }}">
                    ...
                    <div class="card" id="settings-card">
                        ...
                        <div class="card-body">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-sm-6 col-md-9">
                                    <input type="password" name="password"
                                        ...
                                        minlength="8" placeholder="Please Input Password" autofocus autocomplete="off"
                                        required>
                                    @error('password')
                            ...
                            <div class="form-group row align-items-center">
                                <label for="password2" class="form-control-label col-sm-3 text-md-right">Confirm
                                    Password</label>
                                <div class="col-sm-6 col-md-9">
                                    <input type="password" name="password2"
                                        class="form-control @error('password2') is-invalid @enderror" id="password2"
                                        minlength="8" placeholder="Please Input Confirm Password" autocomplete="off"
                                        required>
                                    @error('password2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
