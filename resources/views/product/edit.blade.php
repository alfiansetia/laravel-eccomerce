            ...
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body pt-0">
                        <form id="form" action="{{ route('product.update', $data->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="harga_beli"
                                    ...
                                    placeholder="Please Enter Harga Beli" min="0" value="{{ $data->harga_beli }}">
                                @error('harga_beli')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="harga_jual"
                                    ...
                                    placeholder="Please Enter Harga Jual" min="0" value="{{ $data->harga_jual }}">
                                @error('harga_jual')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="berat"
                                    ...
                                    placeholder="Please Enter Berat" min="0" value="{{ $data->berat }}">
                                @error('berat')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="stock"
                                    ...
                                    placeholder="Please Enter Stock" min="0" value="{{ $data->stock }}">
                                @error('stock')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <img src="{{ $data->image }}" width="100" alt="Product">
                            </div>
                            <div class="form-group">
